...
has-udd のコアエンジン群が属する文脈。document.json を唯一の正とし、AI が構造を推論せず engine が機械的に読み書き・生成・描画する（Harness 原則）。
...
| 種別 | メンバー |
|---|---|
| subdomain | sd-harness-core / sd-validation / sd-rendering |
| aggregate | agg-document / agg-schema |
| usecase | uc-scaffold-document / uc-query-document / uc-validate-document / uc-render-document / uc-scan-source-code / uc-lint-doc-comment |
